...
import TrainiaDB.runtime.util.SQLiteType;
...
public abstract class AExp implements Expression {
     ...
     * <li><code>TrainiaDB.runtime.query.AExp</code></li>
     * </ul>
    ...
    /**
     * Creates a nonterminal logical expression using the LIKE operator
     * It uses <code>this</code> arithmetic expression as left operand.
     *
     * @param aExp right operand
     * @return the created logical expression
     */
    public LExp like(AExp aExp) {
        return LExp.like(this, aExp);
    }
     ...
     * @return the created logical expression
     */
    public LExp like(String pattern) {
        return LExp.like(this, pattern);
    }
