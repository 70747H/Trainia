...
public class ScheduleDAOImpl
        extends TrainiaDB.runtime.dao.BaseDAO<Schedule>
        implements ScheduleDAO {

    public ScheduleDAOImpl(TrainiaDB.runtime.util.SQLiteDataSource dataSource) {
        super(dataSource);
    }
    ...
    @Override
    public Class<Schedule> getPojoClass() {
        return POJO_CLASS;
    }
    ...
    public java.util.List<Schedule> getScheduleList() {
        ...
        TrainiaDB.runtime.dao.SelectObjectListResult<Schedule>
                selectObjectListResult = select(query, RESULT_SET_HANDLER);
        return selectObjectListResult.getObjectList();
    }

    @Override
    public java.util.List<Schedule> getScheduleList(TrainiaDB.runtime.query.AExp orderBy) {
        TrainiaDB.runtime.query.SelectQuery query =
                new TrainiaDB.runtime.query.SelectQuery(TABLE_EXPRESSION);
    ...
    @Override
    public java.util.List<Schedule> getScheduleList(TrainiaDB.runtime.query.AExp orderBy, TrainiaDB.runtime.query.OrderByDirection asc) {
        TrainiaDB.runtime.query.SelectQuery query =
                new TrainiaDB.runtime.query.SelectQuery(TABLE_EXPRESSION);
    ...
    public Schedule getById(Integer id) {
        ...
        java.util.List<Schedule> list = select(query, RESULT_SET_HANDLER).getObjectList();
    ...
    @Override
    public Schedule getSchedule(Workoutlevel workoutlevel) {
        TrainiaDB.runtime.query.SelectQuery query =
                new TrainiaDB.runtime.query.SelectQuery(TABLE_EXPRESSION);
        ...
        lExps.add(ID.eq(workoutlevel.getScheduleId()));
    ...
    @Override
    public java.util.List<Schedule> getScheduleList(TrainiaDB.runtime.query.LExp where) {
        TrainiaDB.runtime.query.SelectQuery query =
                new TrainiaDB.runtime.query.SelectQuery(TABLE_EXPRESSION);
        query.setWhere(where);
    ...
    public long insert(Schedule schedule) {
        ...
        schedule.setId(new Long(id).intValue());

        return id;
    }

    @Override
    public void insert(java.util.Collection<Schedule> schedules) {
    ...
    public void update(Schedule schedule) {
        ...
        lExps.add(TrainiaDB.runtime.query.LExp.eq(ScheduleDAO.ID,
                TrainiaDB.runtime.query.AExp.exp(schedule.getId())));
        TrainiaDB.runtime.query.LExp where = TrainiaDB.runtime.query.LExp.and(lExps);
    ...
    @Override
    public void update(java.util.Collection<Schedule> schedules) {
        for(Schedule obj : schedules) {
            update(obj);
        }
    }
    ...
    @Override
    public void delete(java.util.Collection<Schedule> schedules) {
        for(Schedule obj : schedules) {
            delete(obj);
        }
    }
