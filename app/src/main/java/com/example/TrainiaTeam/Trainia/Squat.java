...
public class Squat extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Squat.this,Profile.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTotalReps = (TextView) findViewById(R.id.textView8);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent((Squat.this),Progress_Squat.class));
            }
        });
        ...
        btnStatistics.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent((Squat.this),BarCharGraphActivity.class));
            }
        });

        manager = new SessionManager();
        ilevelId = Integer.valueOf(manager.getPreferences(Squat.this,"squatSelectedLevelId"));
        iworkoutId = Integer.valueOf(manager.getPreferences(Squat.this,"selectedWorkoutId"));
