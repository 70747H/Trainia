...
public class Pull_up extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(Pull_up.this,Profile.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvTotalReps = (TextView) findViewById(R.id.textView3);
        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent((Pull_up.this),Progress_Pull_Up.class));
            }
        });
        ...
        btnStatistics.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent((Pull_up.this),BarCharGraphActivity.class));
            }
        });

        manager = new SessionManager();
        ilevelId = Integer.valueOf(manager.getPreferences(Pull_up.this,"PullupSelectedLevelId"));
        iworkoutId = Integer.valueOf(manager.getPreferences(Pull_up.this,"selectedWorkoutId"));
